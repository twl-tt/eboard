...
import { BookText, Users, FolderTree, ArrowLeft, Plus, Trash2, Tags, HelpCircle } from "lucide-react"
...
type Tab = "articles" | "students" | "categories" | "tags" | "questions"
...
const TABS: { key: Tab; label: string; icon: React.ReactNode }[] = [
  ...
  { key: "questions", label: "題庫管理", icon: <HelpCircle className="h-4 w-4" /> }
]
